...
func TlsDir() string {
	...
	if tlsDir == "" {
		tlsDir = filepath.Join(getWd(), "cmd", "ponzu", "vendor", "github.com", "tom-camp", "ponzu", "system", "tls")
	}
	return tlsDir
}
...
func AdminStaticDir() string {
	...
	if staticDir == "" {
		...
		staticDir = filepath.Join(getWd(), "cmd", "ponzu", "vendor", "github.com", "tom-camp", "ponzu", "system", "admin", "static")
	}
	return staticDir
}
